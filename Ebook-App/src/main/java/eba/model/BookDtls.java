...
public class BookDtls {
	...
	public BookDtls(String bookname, String author, String price, String bookCatagory, String status, String photoName,
			String email) {
		super();
	...
	public String toString() {
		return "BookDtls [bookId=" + bookId + ", bookname=" + bookname + ", author=" + author + ", price=" + price
				+ ", bookCatagory=" + bookCatagory + ", status=" + status + ", photoName=" + photoName + ", email="
				+ email + "]";
	}
}
